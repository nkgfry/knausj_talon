...
default_alphabet = 'air bat cap drum each fine gust harp sit jury crunch look made near con pit quench red sun trap urge vest whale plex yank zip'.split(' ')
...
ctx.lists['self.symbol'] = {
    ...
    'semi': ';', 'semicolon': ';',
    'quote': "'",
    'L square': '[', 'left square': '[', 'square': '[', 'brack': '[',
    'R square': ']', 'R brack': ']', 'right square': ']',
    'forward slash': '/', 'slash': '/',
    'backslash': '\\',
    'minus': '-', 'dash': '-',
    'equals': '=',
