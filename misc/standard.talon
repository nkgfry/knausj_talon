...
jace: key(alt-shift-f9)
jacer: key(alt-shift-f10)
jack: key(alt-shift-f11)
jacker: key(alt-shift-f12)
fun deck: key(alt-shift-,)
funex: key(alt-shift-.)
bolt: key(alt-shift-home)
bolter: key(alt-shift-end)
class deck: key(alt-shift-[)
new deck: key(alt-shift-])
new deck: key(alt-shift-])
for loop: key(alt-shift-;)
for tom: key(alt-shift-f14)
why loop: key(alt-shift-')
if else: key(alt-shift-keypad_divide)
if lee: key(alt-shift-/)
elle if: key(alt-shift-keypad_minus)
ellie: key(alt-shift-keypad_plus)
